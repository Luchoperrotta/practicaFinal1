...
class UserAccountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_account" do
    assert_difference('UserAccount.count') do
      post user_accounts_url, params: { user_account: { account_id: @user_account.account_id, end: @user_account.end, start: @user_account.start } }
    end
  ...
  test "should update user_account" do
    patch user_account_url(@user_account), params: { user_account: { account_id: @user_account.account_id, end: @user_account.end, start: @user_account.start } }
